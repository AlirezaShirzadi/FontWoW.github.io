...
export const FEATURES = [
  ...
  { iconName: 'IconPalette', title: 'استایل و افکت متن', text: 'بولد، ایتالیک، زیرخط، سایه، دورخط، گرادیان، نئون و جعبه‌های متن آماده.' },
  ...
  { iconName: 'IconDownload', title: 'خروجی و ذخیره', text: 'خروجی PNG با کیفیت بالا، کپی در کلیپ‌بورد، و ذخیره‌ی طرح‌ها در گالری برنامه.' },
]
