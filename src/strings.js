export const STRINGS = {
  fa: {
    ...
    styleStudioHint: 'فونت، رنگ، جعبه، پس‌زمینه و افکتی که الان روی صفحه انتخاب کردی، به‌عنوان یک استایل ذخیره می‌شه.',
  ...
  en: {
    ...
    styleStudioHint: 'The font, color, box, background, and effect currently selected on the canvas will be saved as one style.',
